...
<p class="selectedNav">Character Editor</p>
<p><a href="entityviewer.php?idhash=<?php print($_GET['idhash']); ?>">Entity Viewer</a></p>
<p><a href="eventviewer.php?idhash=<?php print($_GET['idhash']); ?>">Event Viewer</a></p>
</body>
</html>
